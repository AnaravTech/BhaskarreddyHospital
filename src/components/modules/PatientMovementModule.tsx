    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="p-5 rounded-2xl bg-slate-900/80 border border-slate-800/80 space-y-4">
        ...
        <div className="space-y-3">
          {mockPatientMovementLogs.map((log) => (
            <div
              key={log.id}
              className="p-4 rounded-xl bg-slate-950 border border-slate-800/80 hover:border-slate-700 transition flex flex-col sm:flex-row sm:items-center justify-between gap-4"
            >
