      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-900/60 p-6 rounded-2xl border border-slate-800/80">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-cyan-600 hover:bg-cyan-500 text-white text-xs font-semibold shadow-md shadow-cyan-600/20 transition"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-rose-500/20 hover:bg-rose-500/30 text-rose-300 border border-rose-500/30 text-xs font-semibold transition animate-pulse"
          >
                  ...
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-3 h-3 rounded-full animate-ping ${
                        ec.triagePriority.startsWith('Red') ? 'bg-rose-500' : 'bg-amber-500'
                      }`}
                    />
                    <div>
                  ...
                  <div className="text-right">
                    <span
                      className={`px-2 py-0.5 text-[10px] font-bold rounded ${
                        ec.triagePriority.startsWith('Red')
