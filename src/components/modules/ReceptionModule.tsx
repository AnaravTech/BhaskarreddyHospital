...
export const ReceptionModule: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'register' | 'queue'>('queue');
  ...
  const filteredQueue = appointments.filter(
    (apt) =>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="p-5 rounded-2xl bg-slate-900/80 border border-slate-800/80 h-fit">
            ...
            <form onSubmit={handleIssueToken} className="space-y-4">
              ...
              {selectedPatient && validityStatus && (
                <div
              ...
              <button
                type="submit"
                className="w-full py-2.5 rounded-xl bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white text-xs font-bold shadow-md shadow-cyan-600/20 transition"
              >
                    ...
                    <tr key={apt.id} className="hover:bg-slate-800/40 transition">
                      ...
                      <td className="py-3 px-3">
                        {apt.isFollowUp ? (
                          ...
                          <span className="font-semibold text-slate-200">₹{apt.fee}</span>
                        )}
                      </td>
                      <td className="py-3 px-3">
        ...
        <div className="max-w-3xl mx-auto p-6 rounded-2xl bg-slate-900/80 border border-slate-800/80 space-y-6">
          ...
          <form onSubmit={handleRegister} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2 flex justify-end gap-3 pt-4">
              ...
              <button
                type="submit"
                className="px-5 py-2 rounded-xl bg-cyan-600 hover:bg-cyan-500 text-white text-xs font-bold shadow-md shadow-cyan-600/20 transition"
              >
