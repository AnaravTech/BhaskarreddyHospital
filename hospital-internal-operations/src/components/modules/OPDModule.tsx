...
export const OPDModule: React.FC = () => {
  ...
  const [clinicalNotes, setClinicalNotes] = useState(
    'Patient presents with mild occipital headache and fatigue. Regular BP monitoring advised.'
  );
          ...
          {activeApt ? (
            <>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  <div className="p-3 rounded-xl bg-slate-950 border border-slate-800">
                    ...
                    <input
                      ...
                      className="w-full bg-transparent text-sm font-bold text-slate-100 focus:outline-none mt-1"
                    />
                  </div>
              ...
              <div className="space-y-3 pt-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-2 pt-2">
                  <input
                    ...
                    className="sm:col-span-2 bg-slate-950 border border-slate-800 rounded-xl px-3 py-1.5 text-xs text-slate-100"
                  />
                  <input
                    type="text"
                  ...
                  <button
                    ...
                    className="py-1.5 rounded-xl bg-cyan-600 hover:bg-cyan-500 text-white text-xs font-bold"
                  >
                    + Add
                  </button>
                </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 border-t border-slate-800">
                <button
                  type="button"
                  onClick={() => addToast('Scan Uploaded', 'Handwritten prescription OCR digitized successfully.', 'info')}
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-6 py-2.5 rounded-xl bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white text-xs font-extrabold shadow-md shadow-cyan-600/20 transition"
                >
